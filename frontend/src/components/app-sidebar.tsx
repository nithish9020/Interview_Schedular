      ...
      navMain: [
        {
          ...
          url: "#",
          items: [
            { title: "Analytics", url: "/dashboard/analytics", isActive: true, icon: BarChart },
            { title: "Create Interview", url: "#", icon: PlusCircle },
      ...
      navMain: [
        {
          ...
          url: "#",
          items: [
            { title: "My Applications", url: "#", icon: FileText },
            { title: "Book Slots", url: "#", isActive: true, icon: Calendar },
            { title: "Profile", url: "#", icon: User },
          ],
        },
      ],
                      ...
                      <SidebarMenuButton asChild isActive={item.isActive}>
                        ...
                        >
                          {item.icon && (
                            <item.icon
                              className={`w-5 h-5 ${
                                item.isActive ? "text-[#1877F2]" : "text-slate-500"
                              }`}
                            />
                          )}
                          {item.title}
